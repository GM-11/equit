...
echo "Deploy Company Factory Contract to Sepolia"
forge create ./src/CompanyTokenFactory.sol:CompanyTokenFactory --rpc-url https://rpc.testnet.rootstock.io/UdkCPW4RQZD5wJE7bBEraFSkiWlTEk-T --private-key 0x7f3ed3d4b4d6dca6127fca65f465c94cd541938faf126d6c481fe9b8800e502b
fi
